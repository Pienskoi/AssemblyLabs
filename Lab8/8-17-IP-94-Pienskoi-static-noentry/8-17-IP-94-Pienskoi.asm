...
includelib 8-17-IP-94-Pienskoi-dll.lib; calculate

calculate proto :qword, :qword, :qword, :qword, :ptr byte
...
main:
	...
	mov esi, 0
	calc:
		invoke calculate, arrA[8*edi], arrB[8*edi], arrC[8*edi], arrD[8*edi], addr buffer[esi]
